# Contributing to SwiftCart Food Delivery System
...
#### 4.Test your changes: Ensure your changes work as expected and do not introduce any issues.
#### 5.Commit your changes: Commit your changes with a descriptive commit message.
git add .
git commit -m "Description of the feature or bugfix"
#### 6.Push your changes: Push your changes to your fork.
git push origin feature-or-bugfix-description
#### 7.Submit a pull request: Create a pull request from your fork to the main repository. Include a detailed description of your changes.
## Coding Guidelines
